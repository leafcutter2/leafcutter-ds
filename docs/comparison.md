...
Approach|R|python|
--------|-|------|
Model fitting|Full model initialized from null model fit|Full model selected from one initialed from full model or Bayesian Ridge Regression fit|
...
![Histogram of sex and population sample counts.](https://github.com/leafcutter2/leafcutter-ds/tree/main/docs/images/Geuvadis_metadata_breakdown.png)
...
![A scatter plot of the -log10(FDR adjusted p-values) from both implementations](https://github.com/leafcutter2/leafcutter-ds/tree/main/docs/images/leafcutter_pvalue_scatterplot.png)
![Zoomed in scatter plots of the -log10(FDR adjusted p-values) from both implementations](https://github.com/leafcutter2/leafcutter-ds/tree/main/docs/images/leafcutter_pvalue_scatterplot_zoom.png)
...
Significant R| Signficant python|Count|
-------------|-------------------|-----|
Y|Y|53|
N|N|27,700|
Y|N|8|
...
![Histogram of the exclusively significant p-adjusted values from both implementations.](https://github.com/leafcutter2/leafcutter-ds/tree/main/docs/images/leafcutter_nonoverlapping_pvalue_histogram.png)
...
![Bar plot of CPU efficiency (left), and runtime (right) across threads for both implementations.](https://github.com/leafcutter2/leafcutter-ds/tree/main/docs/images/Performance_comparison.png)
