...
<img src="https://github.com/davidaknowles/leafcutter/blob/master/docs/logo.png" width="250"> 
...
The short answer is that the Rstan dependecies that were difficult to install for many users, so we made this python/pyro version to overcome that. At the same time, we took the opportunity to make it compatible with [leafcutter methods to annotate unproductive splicing events](https://github.com/leafcutter2/leafcutter2). 

A much more detailed write-up on this version and how it compares to the R version please see our [docs page](https://leafcutter2.github.io/leafcutter-ds/).
