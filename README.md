...
This repo has a Python/pytorch/pyro reimplementation of the LeafCutter differential splicing test. Users (including us!) often had problems installing the RStan based package.
...
This is compatible with the new leafcutter2 implmetation which annotates unproductive splicing events based on leafcutter clusters. See the [Nature Genetics publication](https://doi.org/10.1038/s41588-024-01872-x) for details.
